  ...
  <div class="main-layout">
    ...
    <aside class="sidebar" :style="{ width: sidebarCollapsed ? '75px' : '220px', paddingLeft: sidebarCollapsed ? '0px' : '15px', transition: 'width 0.3s ease' }">
      ...
      >
        ...
        <label v-show="!sidebarCollapsed">{{ tab.name }}</label>
      </router-link>
      ...
      <div class="tab-btn" @click="logout" style="display: flex; align-items: center; gap: 12px; padding-left: 18px;">
        ...
        <label v-show="!sidebarCollapsed">Logout</label>
      </div>
    </aside>
      ...
      <header class="navbar">
        ...
        <div style="display: flex; flex-direction: row; align-items: center; margin-left: auto;">
          ...
          <div style="display: flex; flex-direction: column; margin-left: 10px; margin-right: 45px;">
            <label style="font-weight: 600; font-size: 1rem; color: black;">Mud Bdiwee</label>
